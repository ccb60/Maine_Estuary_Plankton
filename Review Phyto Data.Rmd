...
It's possible the first is a mis-labeling, since the duplicate is adjacent to
...
Tab in the spreadsheet.  This is likely to be convenient for comparison with
...
correctly.  MY tendency would be to "correct" by the man value of the blanks. 
